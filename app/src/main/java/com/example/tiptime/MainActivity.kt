        ...
        binding.calculateButton.setOnClickListener {
            try{
                ...
                if (binding.roundUpSwitch.isChecked) {
                    val tipResult = TipCalculator.calculateRoundedTip(binding.tipOptions, serviceAmount)
                    ...
                    val secondToast = Toast.makeText(this, "Tip should be: $tipResult", Toast.LENGTH_SHORT)
                    secondToast.show()
                } else {
                ...
                val toast = Toast.makeText(this, "Please add the service amount", Toast.LENGTH_SHORT)
                toast.show()
    ...
    companion object {
        fun calculateTip(radioGroup: RadioGroup, serviceAmount: Double): Int {
            return when (radioGroup.checkedRadioButtonId) {
                ...
                R.id.tip_third_option -> round(serviceAmount * 12 / 100).toInt()
        ...
        fun calculateRoundedTip(radioGroup: RadioGroup, serviceAmount: Double): Int {
            return when (radioGroup.checkedRadioButtonId) {
                ...
                R.id.tip_third_option -> round(serviceAmount * 12 / 100 / 5).toInt() * 5
